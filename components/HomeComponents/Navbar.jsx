    ...
    <div className="w-full mx-auto bg-white border-b h-8 2xl:max-w-7xl">
      <div className="relative flex flex-col w-full p-5 mx-auto bg-white md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div className="flex flex-row items-center justify-between lg:justify-start">
          <Link
            className="tracking-tight uppercase focus:outline-none focus:ring "
            href="/"
          >
            <span className="lg:text-lg uppercase font-bold focus:ring-0">
              IV Trip
            </span>
          </Link>
          <button
        ...
        >
          <Link
            className="px-2 py-2 text-sm  text-black font-semibold lg:px-6 md:px-3 hover:text-blue-600 lg:ml-auto flex "
            href="/flights"
          >
          ...
          <Link
            className="px-2 py-2  flex text-sm text-black font-semibold lg:px-6 md:px-3 hover:text-blue-600"
            href="/hotels"
          >
          ...
          <Link
            className="px-2 py-2 text-sm   flex text-black font-semibold lg:px-6 md:px-3 hover:text-blue-600"
            href="/tour"
          >
